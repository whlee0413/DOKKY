									...
									<td>
										<div class="list-title-wrapper list-activity">
												...
												<span class="list-activity-desc-text" > 
													...
													<c:if test="${rseq == 'N'}"> 
														<i class="fa fa-pencil " aria-hidden="true"></i>
															...
															<a  class="btn btn-success"  href="/boardList?category=${board.category}">
																<c:if test="${ctrg == 'tech'}">Tech</c:if>
																<c:if test="${ctrg == 'job'}">Job</c:if>
																<c:if test="${ctrg == 'notice'}">공지사항</c:if>
																<c:if test="${ctrg == 'daily'}">사는얘기</c:if>
															</a> 
											...
											<h5 class="list-group-item-heading">
												<a href="/boardRead?seq=${board.seq}">${board.title } </a>
											</h5>
										</div>
									</td>
								</tr>
